...
class DebugTableViewController: UITableViewController {
    ...
    // This should never happen because this is always present when the App is running.
    // But just so you know how to track when an object is torn down by the ARC memory manager.
    deinit {
        Util.log("deinit")
    }
