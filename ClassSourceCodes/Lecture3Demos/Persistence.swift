...
class Persistence {
    ...
    static var path: String? {
        ...
        if let dirPaths = NSSearchPathForDirectoriesInDomains(NSSearchPathDirectory.ApplicationDirectory, NSSearchPathDomainMask.UserDomainMask, true) as? [String] where dirPaths.count > 0 {
