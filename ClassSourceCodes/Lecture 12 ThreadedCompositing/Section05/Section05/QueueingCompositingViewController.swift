...
class QueueingCompositingViewController: CompositingViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    class var opQueue: NSOperationQueue {
        dispatch_once(&OpQueueStatic._token) {
            ...
            OpQueueStatic._dispatchOpQueue?.maxConcurrentOperationCount = 4
        }
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        QueueingCompositingViewController.opQueue.maxConcurrentOperationCount = 1
    ...
    override func tableView(tableView: UITableView,
        cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
            ...
            QueueingCompositingViewController.opQueue.addOperation(op)
            return cell
    }
